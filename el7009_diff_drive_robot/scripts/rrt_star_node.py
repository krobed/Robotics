...
class RRTNode(Node):
    ...
    def map_callback(self, msg):
        ...
        self.map_data = data
        self.get_logger().info(f'map values: {np.unique(data)}')
    ...
    def timer_callback(self):
        ...
        if self.goal_position != self.prev_goal:
            ...
            self.plan = self.run_rrt_star(self.goal_position)
    ...
    def run_rrt_star(self, goal):
        rrt = RRTPlanner(self.map_data, self.map_info,self.start_position, goal)
